...
@property (nonatomic) AVAudioPlayer * playMusicPlayer;
...
- (void)playMusic:(NSString *)filename {
    NSError *error;
    NSURL * backgroundMusicURL = [[NSBundle mainBundle] URLForResource:filename withExtension:nil];
    self.playMusicPlayer = [[AVAudioPlayer alloc] initWithContentsOfURL:backgroundMusicURL error:&error];
    [self.playMusicPlayer prepareToPlay];
    [self.playMusicPlayer play];
}
