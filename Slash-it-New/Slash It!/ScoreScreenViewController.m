...
- (IBAction)levelSetbutton:(id)sender {
    
    
    LevelSetScreenViewController *levelSetScreenViewController = [[LevelSetScreenViewController alloc] init];
    levelSetScreenViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"LevelSetScreenViewController"];
    
    [self presentViewController:levelSetScreenViewController animated:YES completion:Nil];
}
